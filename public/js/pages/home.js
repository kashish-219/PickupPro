    ...
    render(`
      <section class="hero">
        <div class="container">
          ...
          <div class="hero__sports">${SPORTS.map((s) => `<button class="hero__sport" title="${s.name}" onclick="navigate('/games?sport=' + '${s.name}')" style="cursor:pointer">${s.emoji}</button>`).join("")}</div>
          <div class="hero__cta">
